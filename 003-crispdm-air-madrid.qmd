...
Posteriormente se agrupan los datos por la variable `zona` y se genera la variable `valor_zona` que representa la media por zona y día. 
...
En el caso de los modelos seleccionados se aplica lags de 1 al 14 por medio de la función `lag_transformer()` creada en el chunk inferior. 
