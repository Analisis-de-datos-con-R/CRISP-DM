...
library(tibbletime)
=======
>>>>>>> 88bfaa3f6cea67faea5626ac0b0cd4ced805ae41
...
La detección de anomalías es importante en el análisis de datos porque permite identificar valores atípicos que pueden distorsionar los resultados y afectar la validez de las conclusiones. 

El método de 1,5 veces el rango intercuartílico es una técnica común utilizada para identificar valores atípicos en un conjunto de datos. El rango intercuartílico (IQR) representa la dispersión de los valores centrales de un conjunto de datos, específicamente el 50% intermedio. Al multiplicar el IQR por 1,5, se establece un umbral para definir qué valores están suficientemente lejos de la norma como para considerarse atípicos.

Bajo este método, si un valor en el conjunto de datos está por encima de 1,5 veces el IQR por encima del tercer cuartil (Q3) o por debajo de 1,5 veces el IQR por debajo del primer cuartil (Q1), se clasifica como un valor atípico. Esto proporciona una medida simple pero efectiva para identificar valores extremos y potencialmente problemáticos en un conjunto de datos.

Además, al tratarse de datos temporales con una clara tendencia. Se tienen en cuenta los valores agrupados por año y mes. 
...
no2_zona %>% 
  ...
  labs(title = "Anomalías NO2 por RI",
...
```{r, echo=FALSE, out.width='100%', fig.align='center', fig.cap='Proceso de ciencia de datos'}
