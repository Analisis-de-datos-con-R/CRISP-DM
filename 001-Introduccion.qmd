...
```{r ciencia-datos, echo=FALSE, out.width='70%', fig.align='center', fig.cap='Diagrama de Venn de la ciencia de datos'}
...
```{r , echo=FALSE, out.width='70%', fig.align='center', fig.cap='Herramientas básicas de R'}
#| label: fig-caja-herramientas
knitr::include_graphics(here::here("img/herramientas.jpg"))
```


**R** tiene tres grandes pilares (véase la Fig. \@ref(fig:caja-herram)) que
son:
...
Por ello, se recurre al repositorio de 
